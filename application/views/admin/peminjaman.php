  ...
  <body>
    <div class="row no-gutters">
      <div class="col-md-10 p-5" style="margin-left: 16%">
        <h3><i class="fas fa-plus-square mr-2 ml-3 mt-5"></i>PEMINJAMAN</h3><hr class="bg-secondary">  
        <section class="isi">
          <div class="form-group">
            <?= $this-> session ->flashdata('message'); ?>
          </div>
          <form method="post" action="<?= base_url('admin/detail_peminjaman')?>"> 
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Id Buku</label>

              <input type="text" class="form-control" id="recipient-name" name="id_buku">
            </div>
            <div class="form-group">
              <label for="recipient-name" class="col-form-label" >Id Peminjam</label>
              <input type="text" class="form-control" id="recipient-name" name="id_anggota">
            </div>
